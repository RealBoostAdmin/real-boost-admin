...
import {QuestionFilterModel} from '../../../../core/models/question/question.model';

interface IPropsFiltersQuestion {
    filters?: QuestionFilterModel;
    filtersEnabled: FilterEnabledModel[];
    setFiltersEnabled: (filters: FilterEnabledModel[]) => void;
}

const FiltersQuestion = ({
                             filters,
                             filtersEnabled,
                             setFiltersEnabled,
                         }: IPropsFiltersQuestion) => {
    const styles = {
        display: 'flex',
        flexDirection: 'row',
        margin: '1em 0',
