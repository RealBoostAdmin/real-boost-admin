...
const THeadLanguage: React.FC = () => {

    const listColumns: IColumnProps[] = [
        {id: 'name', label: 'Name', minWidth: '6rem', align: 'center'},
        {id: 'flag', label: 'Flag', minWidth: '6rem', align: 'center'},
        {id: 'code', label: 'Code', minWidth: '6rem', align: 'center'},
        {id: 'country', label: 'Country', minWidth: '6rem', align: 'center'},
